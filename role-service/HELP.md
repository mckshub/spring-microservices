...
* The original package name 'com.examplecom.mcks.spring.microservices.user-management-service' is invalid and this project uses 'com.examplecom.mcks.spring.microservices.categoryservice' instead.
